...
A single undifferentiated random sequence would make that contract fragile. Adding one decorative tree during generation could consume an extra random value and change every later settlement, ruler, war and Chronicle event. The visible change would be small, but the historical sequence would be rewritten.
