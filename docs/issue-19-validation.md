...
- Debug counters for draw calls, triangles, scene objects and bounded simulation collections.
- A 250 draw-call budget, 350,000-triangle budget and 2,400 scene-object budget.
...
- Scene-object baseline and growth monitoring.
...
4. Requires draw calls, triangles and scene objects to remain within their declared budgets.
5. Requires lights and particles to respect the active profile.
6. Cycles quality profiles and overlays repeatedly.
7. Requires scene-object drift to remain below 80 objects.
