...
ANNALS provides `minimal`, `low`, `balanced` and `high` profiles. Profiles cap:

- device pixel ratio;
- dynamic lights;
- weather particles;
- visible citizens, sheep, birds and smoke;
- market stalls and carts;
- district and local-detail density;
- overlay, terrain and curve segments;
- visible procedural resources.
